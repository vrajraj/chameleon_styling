            ...
            child: Card(
              ...
              Container(
                decoration: BoxDecoration(
                    gradient: LinearGradient(colors:[Colors.pink[300],Colors.purple[400]])),
                child: 
                Column(
                    ...
                    Row(
                     // mainAxisAlignment: MainAxisAlignment.start,
                      children: <Widget>[
                        ...
                        Expanded(
                            flex: 2,
                            child: IconButton(icon: Icon(Icons.collections,size: 30,color: Colors.white,), onPressed: null)),
                        Expanded(
                          flex: 1,
